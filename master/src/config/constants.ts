...
export const HEARTBEAT_WINDOW_MS = process.env.HEARTBEAT_WINDOW_MS ? parseInt(process.env.HEARTBEAT_WINDOW_MS) : 45_000;
export const HEARTBEAT_INTERVAL_MS = 5_000; 
export const DEFAULT_RF = process.env.RF ? parseInt(process.env.RF) : 2; 
